...
int main(void)
{
	...
	DAQmxErrChk (DAQmxCreateCOPulseChanFreq(DOtaskHandle,"PXI1Slot2/ctr0","",DAQmx_Val_Hz,DAQmx_Val_Low,0.0,Acq_freq,0.512));
	DAQmxErrChk (DAQmxCfgDigEdgeStartTrig(DOtaskHandle,"/PXI1Slot2/PFI9",DAQmx_Val_Rising));
	DAQmxErrChk (DAQmxCfgImplicitTiming(DOtaskHandle,DAQmx_Val_ContSamps,1000));
	...
	DAQmxErrChk (DAQmxCfgSampClkTiming(Acq_taskHandle,"",Freq,DAQmx_Val_Rising,DAQmx_Val_FiniteSamps,1000));
	DAQmxErrChk (DAQmxCfgDigEdgeStartTrig(Acq_taskHandle,"/PXI1Slot2/PFI8",DAQmx_Val_Rising));
	...
	DAQmxErrChk (DAQmxCfgSampClkTiming(Scan_taskHandle,"",Freq,DAQmx_Val_Rising,DAQmx_Val_ContSamps,datasize));
	DAQmxErrChk (DAQmxCfgDigEdgeStartTrig(DOtaskHandle,"/PXI1Slot2/PFI9",DAQmx_Val_Rising));
